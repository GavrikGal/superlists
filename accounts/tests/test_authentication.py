...
class GetUserTest(TestCase):
    ...
    def test_gets_user_by_email(self):
        ...
        User.objects.create(email='test.another.dmitry.gal@gmial.com')
        desired_user = User.objects.create(email='test.dmitry.gal@gmial.com')
        found_user = PasswordlessAuthenticationBackend().get_user(
            'test.dmitry.gal@gmial.com'
        )
    ...
    def test_returns_None_if_no_user_with_that_email(self):
        ...
        self.assertIsNone(
            PasswordlessAuthenticationBackend().get_user('test.dmitry.gal@gmial.com')
        )
